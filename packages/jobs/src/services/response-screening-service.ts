...
3. Если оценка больше 2, сгенерируй приветственное предложение (1-2 предложения) для начала диалога с кандидатом. Оно должно быть дружелюбным, персонализированным и мотивирующим продолжить общение.

4. Если оценка больше 2, сгенерируй 3-4 вопроса для кандидата, которые помогут лучше оценить его компетенции. Вопросы должны быть конкретными и связанными с требованиями вакансии и опытом кандидата.
